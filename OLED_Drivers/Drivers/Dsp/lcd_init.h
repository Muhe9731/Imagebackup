...
#define LCD_DC_Clr()   HAL_GPIO_WritePin(GPIOC,GPIO_PIN_4, GPIO_PIN_RESET)//DC
#define LCD_DC_Set()   HAL_GPIO_WritePin(GPIOC,GPIO_PIN_4, GPIO_PIN_SET)
 		     
#define LCD_CS_Clr()   HAL_GPIO_WritePin(GPIOC,GPIO_PIN_5, GPIO_PIN_RESET)//DC
#define LCD_CS_Set()   HAL_GPIO_WritePin(GPIOC,GPIO_PIN_5, GPIO_PIN_SET)//DC

#define LCD_BLK_Clr()  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0, GPIO_PIN_RESET)//BLK
